...
?>
<ul class="mod-listA-list sitemap section ul-level-<?php echo $recursive ?>">
<?php if(isset($pageList['pages'])): ?>
	<?php foreach($pageList['pages'] as $page): ?>
		<?php if($page['Page']['title']): ?>
	<li class="mod-listA-item sitemap-category li-level-<?php echo $recursive ?>"><?php $this->BcBaser->link($page['Page']['title'],$prefix.$page['Page']['url']) ?></li>
		<?php endif ?>
	<?php endforeach; ?>
<?php endif ?>
<?php if(isset($pageList['pageCategories'])): ?>
	<?php foreach($pageList['pageCategories'] as $pageCategories): ?>
	<li class="mod-listA-item sitemap-page li-level-<?php echo $recursive ?>">
